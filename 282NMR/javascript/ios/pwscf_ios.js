function SubmitJob(form,preview)
{
	...
	if (form.cartesianCoordinates.checked) getGeometry("PWSCFFormat", "cartesianCoordinates=true", form.geometry, false);
	else getGeometry("PWSCFFormat", "", form.geometry, false);
